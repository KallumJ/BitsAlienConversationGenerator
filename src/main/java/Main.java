...
public class Main {
    public static void main(String[] args) {
        ...
        Node node = new Node(new String[]{"Hello there! What's your name?"}, new Response[]{response1, response2, response3, response4});

        Node node2 = new Node(new String[]{"Nice to meet you %player_name%!"}, new Response[]{});
        Node node3 = new Node(new String[]{"That's okay."}, new Response[]{});
        ...
        Node node4 = new Node(new String[]{"Can you get me one of those Portable Reactors?"}, new Response[]{response5, response6});

        Node node5 = new Node(new String[]{"Thanks a lot!"}, new Response[]{});
        Node node6 = new Node(new String[]{"That's okay."}, new Response[]{});
